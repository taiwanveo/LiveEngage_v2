...
1. [references/LiveEngage_SRS_軟體需求規格書.docx](./references/LiveEngage_SRS_軟體需求規格書.docx) — 需求與驗收條件（AC）
2. [references/LiveEngage_SDS_軟體設計規格書.docx](./references/LiveEngage_SDS_軟體設計規格書.docx) — 架構與契約
3. [docs/LiveEngage_AI_Coding_Agent_實作指引.md](./docs/LiveEngage_AI_Coding_Agent_實作指引.md) — 鐵律、目錄、Sprint、DoD
